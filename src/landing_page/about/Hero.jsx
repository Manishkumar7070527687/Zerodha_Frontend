  ...
  return (
    <div className="container">
      <div className="row p-3">
        <h1 className="fs-4 text-center p-5 mt-4 text-muted ">
      ...
      <div className="col-6">
        ...
        <p>And yet, we are always up to something new every day. <br /> Catch up on the latest updates on our  <a href="" style={{textDecoration:"none"}}>blog </a> or see what <br /> the media is  <a href="" style={{textDecoration:"none"}}>saying about us </a> or learn more about our  <br />business and product <a href="" style={{textDecoration:"none"}}>philosophies </a> .</p>
      </div>
      </div>
    </div>
  );
